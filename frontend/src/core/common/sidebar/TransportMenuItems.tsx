              ...
              <ul>
                <li className="submenu">
                  <Link
                    ...
                    className={`${subOpen === "Add School" ? "subdrop" : ""} ${all_routes.addSchools === location.pathname
                        ? "active"
                        : ""
                      }`}
                  >
                ...
                <li className="submenu">
                  <Link
                    ...
                    className={`${subOpen === "Get All Schools" ? "subdrop" : ""
...
export default TransportMenuItems;
