...
import { getAllFees } from '../../../../services/admin/feesApi';
import { toast } from 'react-toastify';

const FeesTypes = () => {
  const routes = all_routes;
  const dropdownMenuRef = useRef<HTMLDivElement | null>(null);
  const [feesTypes, setFeesTypes] = useState<any[]>([]);
        ...
        <div className="content">
          ...
          <div className="card">
            ...
            <div className="card-body p-0 py-3">
              {feesTypes.length === 0 ? (
                <div className="text-center">No fees types found.</div>
              ) : (
                  ...
                  <tbody>
                    {feesTypes.map((fee) => (
                      <tr key={fee.id}>
                        ...
                        <td>
                          <button className="btn btn-sm btn-warning me-1" data-bs-toggle="modal" data-bs-target="#edit_fees_Type">Edit</button>
