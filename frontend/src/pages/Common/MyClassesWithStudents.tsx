...
//     (classId: string) => {
//       return classList.find((cls) => cls.id === classId)?.name || classId;
//     },
//     [classList]
//   );
...
//                 <li>
//                   <Link
//                     to={routes.teacherDashboard}
//                     className={isDark ? "text-blue-300 hover:underline" : "text-blue-500 hover:underline"}
//                   >
//                     Dashboard
//                   </Link>
//                 </li>
//                 <li className="before:content-['/'] before:mx-2">Classes</li>
//               </ol>
//             </nav>
//           </div> */}
//         </div>
...
const MyClassesWithStudents = () => {
  ...
  const currentDateTime = new Date("2025-06-20T19:38:00+05:30"); 
