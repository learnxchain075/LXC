...
import { isSuperAdmin, isSchoolAdmin } from '../middleware/roleCheck';
import { createTemplate, getTemplates, createChannel, getLogs, sendNotification, trigger } from '../controllers/notificationController';
