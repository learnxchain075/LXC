...
export const CONFIG = {
  ...
  // TODO: We need to change the email configuration below later
    // Email Settings
    EMAIL_IMAGE_BASE_URL: process.env.EMAIL_IMAGE_BASE_URL || "",
    EMAIL_FROM_NAME: process.env.EMAIL_FROM_NAME || "",
    EMAIL_FROM_EMAIL: process.env.EMAIL_FROM_EMAIL || "",
    EMAIL_AUTH_USERNAME: process.env.EMAIL_AUTH_USERNAME || "", //gmail or AWS SES
    EMAIL_AUTH_PASSWORD: process.env.EMAIL_AUTH_PASSWORD || "", //gmail or AWS SES
    ...
    SUPPORT_EMAIL: process.env.SUPPORT_EMAIL || "contact@learnxchain.io",
